...
def importAlleleDirFromSettings(projectName):
	try:
		...
		return (settingsObj.SUBDIR_ALLELES)
...
def importRefDirFromSettings(projectName):
	try:
		settingsObj = __import__(projectName + ".settings", globals(), locals(), ['SUBDIR_REFERENCES'], 0)
		# print(settingsObj.DIR_ALLELES)

		return (settingsObj.MEDIA_ROOT +  settingsObj.SUBDIR_REFERENCES)
